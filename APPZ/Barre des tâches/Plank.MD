...
sed -i 's/<property name\="show_dock_shadow" type\="bool" value="true"\/>/<property name\="show_dock_shadow" type\="bool" value="false"\/>/' .config/xfce4/xfconf/xfce-perchannel-xml/xfwm4.xml
```
