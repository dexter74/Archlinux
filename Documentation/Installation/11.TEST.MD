...
NETWORK_INTERFACE3=$(ip link | grep "3: " | cut -c 4-9 | cut -d ':' -f 1)
...
```bash
clear;
echo "Interface 1: $NETWORK_INTERFACE1" && echo "Interface 2: $NETWORK_INTERFACE2" && echo "Interface 3: $NETWORK_INTERFACE3"
```
