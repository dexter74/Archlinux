...
```bash
clear;
pacstrap -i /mnt --noconfirm xfce4;
pacstrap -i /mnt --noconfirm xfce4-goodies;
pacstrap -i /mnt --noconfirm xfce4-dev-tools;
pacstrap -i /mnt --noconfirm gvfs;
pacstrap -i /mnt --noconfirm thunar-archive-plugin thunar-media-tags-plugin thunar-volman xfdesktop;
pacstrap -i /mnt --noconfirm libgsf libopenraw ffmpeg ffmpegthumbnailer libgepub poppler poppler-glib
pacstrap -i /mnt --noconfirm gvfs-gphoto2 gvfs-mtp gvfs-nfs gvfs-smb;
pacstrap -i /mnt --noconfirm seahorse;
pacstrap -i /mnt --noconfirm pavucontrol;
pacstrap -i /mnt --noconfirm pipewire;
```
...
#### C. Configuration du srvice SystemD-Resolved
```bash
clear;
echo "[Resolve]
DNS=$NETWORK_DNS1
