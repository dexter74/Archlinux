...
IPv6AcceptRA=no " > /etc/systemd/network/20-$NETWORK_WIFI_INTERFACE.network ;
################################################################################################################
echo "[Match]
Type=ether
[Network]
...
ETAT_WPA=$(systemctl status wpa_supplicant@$NETWORK_WIFI_INTERFACE  | grep "Active:" | cut -c14-20 | cut  -d '(' -f 1)
clear ;
