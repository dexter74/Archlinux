...
------------------------------------------------------------------------------------------------------------------------------
#  Explication sur l'installation de Windows
```bash
...
### A. Création des dossiers et des fichiers vide (permissions incluse)
...
### B. Configurer les Hooks de Libvirt (kvm.conf)
...
------------------------------------------------------------------------------------------------------------------------------
#  Création des scripts d'autmatisation
