...
#### 0. [FIX] Mise à jour des Clés PGP
```shell
...
```
------------------------------------------------------------------
#### 10. Configuration Host et Hostname
```shell
clear;
NAME=Arch
DOM=LAN
...
------------------------------------------------------------------
#### 13. Modification des fichiers de Configuration
```shell
clear;
